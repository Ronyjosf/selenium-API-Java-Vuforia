 ...
 */
public class DeleteTarget extends BaseTarget implements TargetStatusListener {
	...
	DeleteTarget(String inputTargetId){
		targetId = inputTargetId;
	}
	public void deleteTarget() throws URISyntaxException, ClientProtocolException, IOException, JSONException {
		...
		if (!(jobj.get("result_code").toString().contains("Success")))
			throw new HttpResponseException(404, jobj.get("result_code").toString());
	}
	...
	@Override
	public void OnTargetStatusUpdate(TargetState target_state) throws JSONException {
